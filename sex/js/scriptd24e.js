...
const commands = {
	...
	{
		cmd: 'skids',
		res: ':<span class="red"></span><br>#<span class="red"> ilymonkey</span><br># <span class="red"> faith</span><br></span>'
	},
	links: 
	{
		cmd: 'links',
		res: 'Links:<br># <span class="red"><a href="https://discord.gg/luv" target="_blank"><u>Discord</u></a></span> - My Discord Account.<br># <span class="red"><a href="https://github.com/criminalism" target="_blank"><u>Github</u></a></span> - Where i post my code<br># <span class="red"><a href="https://steamcommunity.com/id/armyman6549" target="_blank"><u>Steam</u></a></span> - You can find me there <span class="green">Online</span> most of the time.<br># <span class="red"><u></u></a></span>'
	},
	visitors: 
	{
		cmd: 'visitors',
...
var prephraseRoot = '<span class="red">root@c0d3r.me</span>:<span class="blue">~</span># ';
var prephrase = '<span class="red">guest@c0d3r.me</span>:<span class="blue">~</span># ';
...
{
	var res = '';
	if (command === './welcome.sh') res = 'wlc to <span class="red">c0d3r.me</span>!<br></span><br>Made By:</span><span class="red"> ilymonkey</span><br>Total Visits: <span class="red">actually idk but heres my number of logged ips: 420</span><br>Terminal Updated: <span class="red">never.</span><br><a href="" target="_blank"><u></u></a>:<span class="red"></span><br><br><b>Type \'help\' for more details on the commands</b>'
	else
	{
...
$('form').on('submit', function(e) {
	...
	try {
			...
			if (vInput.startsWith("./")) {
				if (vInput === "./root/welcome.sh") {
					...
					launchCommandAsVisitor({
						cmd: vInput,
						res: '<div><p>c0d3r.me: ' + vInput + ': No such file or directory</p></div>'
					});
				}
				...
				if (typeof loginArray[2] !== "undefined") {
					if (loginArray[2] === "visitor") {
						...
						res = 'c0d3r.me: No passwd entry for user ' + loginArray[2] + '';
					}
					launchCommandAsVisitor({
				...
				if (vInput === "music play") {
					...
					launchCommandAsVisitor({
						cmd: vInput,
						res: '<div><p>[ <span class="red">c0d3r.me</span> ] Usage: music [play/stop/link]</p></div>'
					});
				}
				...
				if (vInput === "friend joffrey") {
					...
					launchCommandAsVisitor({
						cmd: vInput,
						res: '<div><p>[ <span class="red">c0d3r.me</span> ] Usage: friend [name/list]</p></div>'
					});
				}
		...
		if (root > 0) {
			launchCommandAsRoot({
				cmd: $('input').val(),
				res: '<div><p>c0d3r.me: ' + $('input').val() + ': command not found</p></div>'
			});
		} else {
			launchCommandAsVisitor({
				cmd: $('input').val(),
